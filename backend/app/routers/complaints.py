...
def list_complaints(
    ...
    # High enough that the dashboard loads the whole corpus in one request.
    # A silently truncated page would make every total on the dashboard
    # wrong. A production deployment would paginate instead.
